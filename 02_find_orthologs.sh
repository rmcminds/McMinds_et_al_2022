...
## only run salmon on transcripts that have human ensembl family members. maybe don't worry about potential pooling until at the tx2gene step for tximport
